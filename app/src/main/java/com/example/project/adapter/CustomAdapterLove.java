...
public class CustomAdapterLove  extends ArrayAdapter {
    private Context context;
    private int layoutId;
    private TruyenEvent event;
    private ArrayList<Truyen> truyenData = new ArrayList<>();

    public CustomAdapterLove(@NonNull Context context, int layoutId, ArrayList<Truyen> truyenData, TruyenEvent event) {
